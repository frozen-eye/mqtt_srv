...
int main(int argc, char** argv) {
    ...
    // It is not needed to guard this counter as it is
    long long total_pkts = 0;

    s.set_accept_handler(
        [&connections, &subs, &total_pkts](con_sp_t spep) {
            auto& ep = *spep;
            ...
            ep.set_publish_handler(
                ...
                (MQTT_NS::optional<packet_id_t> packet_id,
                 ...
                 MQTT_NS::buffer contents){
                    ...
                    std::cout << "[server] total_pkts: " << ++total_pkts << std::endl;
                    return true;
                });
    ...
    std::cout << "MQTT server listening on port " << argv[1] << std::endl;
